...
DUAL_MODELS="${ARIADNE_LLAMA_DUAL_MODELS:-Qwen3.6-27B-MTP-Q6_K Qwen3.6-35B-A3B-MTP-UD-Q8_K_XL}"
TEXT_MTP_MODEL="${ARIADNE_LLAMA_TEXT_MTP_MODEL:-Qwen3.6-27B-MTP-Q6_K}"
